...
//
    ...
    {
        GET("http://api.nlecloud.com/Projects/32352/Sensors?AccessToken="+Token,2);//项目ID 32343
        //Sensor();
    }

    public void b3_click(View view)
    {
        GET("http://api.nlecloud.com/Devices/Status?devIds=38495&AccessToken="+Token,3);//设备ID 38484
    }
